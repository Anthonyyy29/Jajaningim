...
Route::middleware('guest')->group(function () {
    ...
    // Lupa password — nama route password.request/password.reset wajib persis
    // seperti ini karena notifikasi ResetPassword bawaan Laravel generate link
    // pakai route('password.reset', ...).
